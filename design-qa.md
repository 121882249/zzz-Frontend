...
- Replaced the square amount-explanation popup with a 14px rounded card whose dark fill and muted blue outline follow the rest of the account-card styling.
