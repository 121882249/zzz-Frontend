...
final class CodexConversationRepairTest {
    static int run() throws Exception {
        ...
        CodexConversationRepair.Result result = CodexConversationRepair.repair(factory, "tp-g57-fixture");
        require(result.discovered() == 4 && result.alreadyOpenAi() == 1 && result.attempted() == 3,
