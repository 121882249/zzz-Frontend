...
final class SelfTest {
    static void run() throws Exception {
        int passed = NetworkProxyTest.run() + CodexSwitchConfigTest.run() + CodexConversationRepairTest.run();
        ...
        check(!Updater.patchEntryAllowed("assets/CodexCommandLine.png") && !Updater.patchEntryAllowed("assets/changed.png") && !Updater.patchEntryAllowed("../bad.class"), "incremental update rejects assets and traversal for old-client compatibility"); passed++;
        ...
        passed += WindowsUpdaterTest.run();
        passed += LoginControlsTest.run();
        passed += ModelSelectionReconcilerTest.run();
